...
<body>
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown active"><a><span>Service Type</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
  ...
  <h1 style="text-align: center;">All service packages with <%out.print(request.getParameter("name"));%>:</h1><br>
