...
<body>
    ...
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li id="purchased"><a class="nav-link active" href="<%= request.getContextPath() %>/PurchasedOrders.do">Purchased Orders</a></li>
  ...
  <main style="padding:50px" id="main">
	...
	<br>
    <div id="purchasedOrder">
      <h1 style="text-align: center;">Purchased orders:<br></h1>
      <br>
      <div id="purchasedTable" class="row row-cols-1 row-cols-md-3 g-4"></div>
    </div>
  ...
  <script>
        container = document.getElementById('purchasedTable');
        var command = '';
        <%for (int j = 0; j < Integer.parseInt(request.getParameter("allPPackageSize")); j += 1) {%>
		<% String i = ("" + j).trim();%>
             ...
             +'<table style="margin-left:auto;margin-right:auto;">'
               +'<tr>'
                 +'<td style="padding: 0 15px;">'
                   +'<b>Package: </b>'
                 +'</td>'
                 +'<td style="padding: 0 15px;">' + "<%out.print(request.getParameter("PackagePName" + i));%>" + '</td>'
               +'</tr>'
               +'<tr>'
                 +'<td style="padding: 0 15px;padding-top:5px;">'
                   +'<b>Order date:</b>'
                 +'</td>'
                 +'<td style="padding: 0 15px;padding-top:5px;">' + "<%out.print(request.getParameter("PackagePTimestamp" + i));%>" + '</td>'
               +'</tr>'
               +'<tr>'
                 +'<td style="padding: 0 15px;padding-top:5px;"><b>Starting period:</b></td>'
                 +'<td style="padding: 0 15px;padding-top:5px;">' + "<%out.print(request.getParameter("PackagePSP" + i));%>" + '</td>'
               +'</tr>'
               +'<tr>'
                 +'<td style="padding: 0 15px;padding-top:5px;"><b>End period:</b></td>'
                 +'<td style="padding: 0 15px;padding-top:5px;">' + "<%out.print(request.getParameter("PackagePEP" + i));%>" + '</td>'
               +'</tr>'
               +'<tr>'
               ...
               +'<tr style="padding:50px;">'
                 ...
                 +'<td style="padding: 0 15px;">' + "<%out.print(request.getParameter("PackagePPrice" + i));%>" + '</td>'
               +'</tr>'
             +'</table>'
             +'<br>'
