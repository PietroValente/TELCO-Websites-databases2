...
/**
 * Servlet implementation class Service_Type
 */
@WebServlet("/ServiceType.do")
public class ServiceType extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String type = null;
		if (request.getParameter("name").equals("mobilephone")) {
			type = "mobilephone";
		} else if (request.getParameter("name").equals("fixedphone")) {
			type = "fixedphone";
		} else if (request.getParameter("name").equals("fixedinternet")) {
			type = "fixedinternet";
		} else {
			type = "mobileinternet";
		}
		List<Pack> allPackage = manager.getPackages(type);
		...
		RequestDispatcher view = req.getRequestDispatcher("pages/ServiceType.jsp");
